...
#     'Spectrum Maps',
#     href='/index/hello',
#     label=__('Spectrum Maps'),
#     icon='fa-signal',
#     category='Expert Analysis',
#     category_label=__('Expert Analysis'),
#     category_icon='fa-group')
#
# appbuilder.add_link(
#     'Waterfall Charts',
#     href='/index/hello',
#     label=__('Waterfall Charts'),
#     icon='fa-bar-chart',
#     category='Expert Analysis',
#     category_label=__('Expert Analysis'),
#     category_icon='fa-group')
...
# appbuilder.add_link(
#     'Equip-Moda Mapping',
#     href = 'equipmodelmapping',
#     label=__('Equip-Moda Mapping'),
#     icon='fa-link',
#     category='Expert Analysis',
#     category_label=__('Expert Analysis'),
#     category_icon='fa-group'
...
#     'Model Management',
#     href='/index/hello',
#     label=__('Model Management'),
#     icon='fa-superscript',
#     category='Model Management',
#     category_label=__('Model Management'),
#     category_icon='fa-superscript')
...
class Superset(BaseSupersetView):
    ...
    def sqllab(self):
        ...
        q = json.dumps(d, default=utils.json_iso_dttm_ser)
        return self.render_template(
            'superset/basic.html',
            entry='sqllab',
    ...
    @expose('/equipmodelmapping')
    def equipmodelmapping(self):
        'equip model mapping'
        q = self.render_template('superset/table_data_tables.html')
        return self.render_template('superset/table_data_tables.html')
