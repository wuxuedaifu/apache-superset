...
export const visTypes = {
  ...
  echarts_stackbarline: {
    label: t('Time Series - echarts_stack bar line Chart'),
    requiresTime: true,
    controlPanelSections: [
      {
        label: t('Chart Options'),
  ...
  echarts_mixlinebar: {
    label: t('Time Series - echarts_mix line bar Chart'),
    requiresTime: true,
    controlPanelSections: [
      {
        label: t('Chart Options'),
...
///DF echarts_3DLine 面板控件
  echarts_3DLine: {
    label: t('echarts 3D Line'),
    controlPanelSections: [
      {
        label: t('Query'),
        expanded: true,
...
///DF echarts_baseLine 面板控件
echarts_baseLine: {
  label: t('echarts base Line'),
  controlPanelSections: [
    {
      label: t('Query'),
      expanded: true,
