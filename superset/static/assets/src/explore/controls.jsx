...
const INSTR_NAMES = ['风机1', '风机2', '风机3', '压榨机1', '压榨机2', '果汁机1'];
const virabtion_channel = ['1','2','3','4','5']
...
export const controls = {
  ...
  metrics_2: {
    ...metrics,
    label: t('Right Axis Metrics'),
    clearable: true,
    description: t('Choose one or more metric for right axis'),
  },
  ...
  device_id: {
    ...
    label: 'device_id',
    default: null,
    description: t('device id columns'),
    choices: formatSelectOptions(INSTR_NAMES),
    // mapStateToProps: state => ({
    //   choices: (state.datasource) ? state.datasource.all_cols : [],
    // }),
  },
  ...
  virabtion_channel_id: {
    type: 'SelectControl',
    label: 'virabtion_channel_id',
    default: null,
    choices: formatSelectOptions(virabtion_channel),
    description: t('vibration channel columns'),
    /*// mapStateToProps: state => ({
    //   choices: (state.datasource) ? state.datasource.all_cols : [],
    }),*/
  },
  ...
  pie_label_type: {
    ...
    choices: [
      ...
      ['value_percent', 'Value and Percentage'],
      ['key_value_percent', 'Category and Value and Percentage'],
    ],
