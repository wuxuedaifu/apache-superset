...
export const VIZ_TYPES = {
  ...
  dual_line: 'dual_line',
  line_bar: 'line_bar',
  echarts_mixlinebar: 'echarts_mixlinebar',
  echarts_stackbarline: 'echarts_stackbarline',
  echarts_3DLine: 'echarts_3DLine',
  echarts_baseLine: 'echarts_baseLine',
...
const vizMap = {
  ...
  [VIZ_TYPES.echarts_mixlinebar]: () =>
    loadVis(import(/* webpackChunkName: "echarts_mixlinebar" */ './echarts_mixlinebar.js')),
  [VIZ_TYPES.echarts_stackbarline]: () =>
    loadVis(import(/* webpackChunkName: "echarts_stackbarline" */ './echarts_stackbarline.js')),
  ...
  [VIZ_TYPES.echarts_funnel]: () => loadVis(import(/* webpackChunkName: "rose" */ './echarts_funnel.js')),
  [VIZ_TYPES.echarts_3DLine]: () => loadVis(import(/* webpackChunkName: "rose" */ './echarts_3DLine.js')),
  [VIZ_TYPES.echarts_baseLine]: () => loadVis(import(/* webpackChunkName: "rose" */ './echarts_baseLine.js')),
};
